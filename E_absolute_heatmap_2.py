...
A standalone gradient legend is saved as a separate file so it can be
placed freely in a figure panel without cluttering the heatmap axes.
...
Usage
-----
    python 06_absolute_heatmap.py --fasta proteins.fasta

    python 06_absolute_heatmap.py \\
